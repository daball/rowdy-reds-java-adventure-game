<?php
	...
	$roomDescriptions = array(
		...
		"goldilocksRoom"    => "You are in a bedroom with three beds.  A fire crackles in the fireplace, making the room soft, warm, and comfortable.",
	...
	if(!isset($_SESSION['roomImage']))
	{
		$_SESSION['roomImage'] = array(
			...
			"corridor2fn"       => "corridor2fn.jpg",
			"corridor2fs"       => "corridor2fs.jpg",
			"mapRoom"           => "mapRoom.jpg",
			"billiardsRoom"     => "billiardsRoom.jpg",
			"goldilocksRoom"    => "goldilocksRoom.jpg",
	...
	$roomConnections = array(
		...
		"corridor2fsEast"       => "masterBedchambers",
		"masterBedchambersWest" => "corridor2fs",
