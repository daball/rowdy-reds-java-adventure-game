  ...
  public static function buildMap()
  {
    return (new MapBuilder())
      ...
      ->createRoom('conservatory')
        ->setRoomDescription('conservatory', "You are in a beautiful conservatory with many exotic plants and a greenhouse ceiling.")
        ->setRoomImageUrl('conservatory', 'conservatory.jpg')
      ->createRoom('lounge')
        ->setRoomDescription('lounge', "You are in a lounge decorated with many paintings, and nice comfortable searting.  There is a door to the east.")
        ->setRoomImageUrl('lounge', 'lounge.jpg')
      ->createRoom('butlersQuarters')
        ->setRoomDescription('butlersQuarters', "You are in the butler's quarters.  You see stairs that lead to nowhere, and some tables and chairs.  It seems the butler must be a lush since he has an entire tavern in his quarters!")
        ->setRoomImageUrl('butlersQuarters', 'butlersQuarters.jpg')
      ->createRoom('kitchen')
        ->setRoomDescription('kitchen', "You are in the kitchen.  The smell of freshly cooked meat still lingers heavily in the air.")
        ->setRoomImageUrl('kitchen', 'kitchen.jpg')
      ->createRoom('pantry')
        ->setRoomDescription('pantry', "You descend down some stairs into in the kitchen pantry.  The pantry is stocked with many dry goods.")
