...
class UserAcceptanceTest extends PHPUnit_Extensions_Selenium2TestCase
{
  ...
  {
    $this->url("http://localhost/Game");
    $this->assertEquals("Rowdy Red's Java Adventure", $this->title());
  }
